...
public class GatePayClientTest {
    ...
    public void testQueryConvertOrder() {
        com.gatepay.api.convert.model.req.QueryOrderReq queryOrderReq = new com.gatepay.api.convert.model.req.QueryOrderReq();
    ...
    public void testQueryWebOrder() {
        com.gatepay.api.web.model.req.QueryOrderReq queryOrderReq = new com.gatepay.api.web.model.req.QueryOrderReq();
    ...
    public void testCreateWebRefund() {
        com.gatepay.api.web.model.req.CreateRefundReq createRefundReq = new com.gatepay.api.web.model.req.CreateRefundReq();
    ...
    public void testQueryWithdrawOrder() {
        com.gatepay.api.withdraw.model.req.QueryOrderReq queryOrderReq = new com.gatepay.api.withdraw.model.req.QueryOrderReq();
    ...
    public void testQueryWithdrawBalance() {
        com.gatepay.api.withdraw.model.req.QueryBalanceReq queryChainsReq = new com.gatepay.api.withdraw.model.req.QueryBalanceReq();
